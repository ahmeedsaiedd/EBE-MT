  ...
  <div
    ...
    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg max-w-lg w-full">
        ...
        <form id="checkbox-form">
            ...
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                    <input type="checkbox" name="user-story" class="mr-2 checkbox-option" data-target="user-story-form">
                    User Story
                </label>
            </div>
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                    <input type="checkbox" name="test-cases" class="mr-2 checkbox-option" data-target="test-cases-form">
                    Test Cases
                </label>
            </div>
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                    <input type="checkbox" name="test-set" class="mr-2 checkbox-option" data-target="test-set-form">
                    Test Set
                </label>
            </div>
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                    <input type="checkbox" name="test-execution" class="mr-2 checkbox-option" data-target="test-execution-form">
                    Test Execution
                </label>
            </div>
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                    <input type="checkbox" name="bug" class="mr-2 checkbox-option" data-target="bug-form">
                    Bug
                </label>
            </div>
      ...
      <div id="dynamic-form-container" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50" style="display: none;">
          <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg max-w-lg w-full">
              <h2 id="dynamic-form-title" class="text-lg font-semibold mb-4">Dynamic Form</h2>
                ...
                <li class="relative">
                  ...
                  >
                    <img
                      ...
                      img src="{{ asset('pp.png') }}" alt="Logo" class="w-100% h-20">
                  </button>
...
document.querySelectorAll('.checkbox-option').forEach(checkbox => {
    checkbox.addEventListener('change', function(event) {
        if (event.target.checked) {
            showDynamicForm(event.target.dataset.target);
        }
    });
});
