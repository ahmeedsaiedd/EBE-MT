                ...
                <div id="create-project-modal"
                    ...
                    <div class="bg-white rounded-lg shadow-lg w-11/12 md:w-1/2 lg:w-1/3 p-6">
                        ...
                        <form id="checkbox-form" action="{{ route('project.store') }}" method="POST" class="space-y-4">
                            ...
                            <div>
                                <label for="project_type" class="block text-sm font-medium text-gray-700">Project
                                    Type:</label>
                            ...
                            <div class="flex justify-end">
                                <button type="button" id="cancel-btn"
                                    class="mr-3 inline-flex justify-center py-2 px-4 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Cancel</button>
                        ...
                        <form id="checkbox-form" action="{{ route('project.store') }}" method="POST" class="space-y-4">
                            ...
                            <div class="flex justify-end">
                                <button type="button" id="close-modal"
                                    class="ml-4 px-4 py-2 bg-gray-200 text-gray-800 rounded-md shadow-sm hover:bg-gray-300">Cancel</button>
                                <button type="submit" id="submit-form-btn"
                                    class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Submit</button>
                            </div>
                        </form>
